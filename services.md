  ...
  <div class="row">
    <nav class="col-sm-3 hidden-print hidden-xs hidden-sm">
      <ul class="nav nav-pills nav-stacked" data-spy="affix" data-offset-top="205">
        ...
        <div class="col-sm-9">
            <h2 id="section-1">Web Development Services</h2>
            ...
            <hr>
            <h2 id="section-2">Mobile Development Services</h2>
            ...
            <hr>
            <h2 id="section-3">eCommerce Development Services</h2>
            ...
            <hr>
            <h2 id="section-4">Website Optimization &amp; SEO Services</h2>
            ...
            <hr>
            <h2 id="section-5">Website Support Services</h2>
